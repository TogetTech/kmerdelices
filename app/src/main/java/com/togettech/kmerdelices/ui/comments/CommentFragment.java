...
import com.togettech.kmerdelices.Adapter.MyCommentAdapter;
import com.togettech.kmerdelices.Callback.ICommentCallbackListener;
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot commentDataSnapshot:dataSnapshot.getChildren()){
                            ...
                            CommentModel commentModel = commentDataSnapshot.getValue(CommentModel.class);
