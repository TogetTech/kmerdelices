...
import com.togettech.kmerdelices.mapbox.adapter.LocationRecyclerViewAdapter;
import com.togettech.kmerdelices.mapbox.model.IndividualLocation;
import com.togettech.kmerdelices.mapbox.util.LinearLayoutManagerWithSmoothScroller;
...
public class ExploreActivity extends AppCompatActivity implements LocationListener,
    ...
    private static final LatLngBounds LOCKED_MAP_CAMERA_BOUNDS = new LatLngBounds.Builder()
            .include(new LatLng(3.884650, 11.508737))
            .include(new LatLng(3.884650, 11.508737)).build();
    private static final LatLng MOCK_DEVICE_LOCATION_LAT_LNG = new LatLng(3.883435, 11.502885);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(final MapboxMap mapboxMap) {
                ...
                customThemeManager = new CustomThemeManager(chosenTheme, ExploreActivity.this);
                ...
                mapboxMap.setStyle(new Style.Builder().fromUrl(customThemeManager.getMapStyle()), new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        ExploreActivity.this.mapboxMap = mapboxMap;
                        ...
                        if (featureList != null) {
                            ...
                            mapboxMap.addOnMapClickListener(ExploreActivity.this);

                            Toast.makeText(ExploreActivity.this, "Cliquez sur une carte", Toast.LENGTH_SHORT).show();
    ...
    private void getInformationFromDirectionsApi(Point destinationPoint,
        ...
        directionsApiClient.enqueueCall(new Callback<DirectionsResponse>() {
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                Toast.makeText(ExploreActivity.this, R.string.failure_to_retrieve, Toast.LENGTH_LONG).show();
            }
        });
    }
